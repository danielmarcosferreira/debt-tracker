...
const en = {
  ...
  "due.overdueYesterday": "was due yesterday",
  "due.overdueDays": "was due {days} days ago",
  ...
  "cards.totalAvailable": "Total available",
  "cards.tabCards": "Cards",
  "cards.tabInvoices": "Invoices",
  "cards.monthlyPaymentsEmptyTitle": "Nothing owed this month",
  "cards.monthlyPaymentsEmptyDesc": "You're all caught up for this month",
  "cards.paymentCount_one": "{count} expense",
  "cards.paymentCount_other": "{count} expenses",
  "cards.invoicesPending": "Pending",
  "cards.invoicesAll": "All",
  "cards.invoicePaid": "Paid",
  ...
  "cardDetail.emptyDescMonth": "No expenses on this card in {month}.",
  "cardDetail.emptyDescMonthFiltered": "No {filter} expenses on this card in {month}.",
  "cardDetail.remainingToPay": "Left to pay",
  "cardDetail.invoiceTotal": "Invoice total",
  "cardDetail.markMonthPaid": "Mark {month} invoice as paid",
  "cardDetail.markMonthPaidDesc": "Marks this card's {month} invoice as paid to the issuer — doesn't change who owes you for each expense",
  "cardDetail.monthPaid": "{month} invoice is paid",
  "cardDetail.undoMarkMonthPaid": "Undo",
...
const pt: Record<TranslationKey, string> = {
  ...
  "due.overdueYesterday": "venceu ontem",
  "due.overdueDays": "venceu há {days} dias",
  ...
  "cards.totalAvailable": "Total disponível",
  "cards.tabCards": "Cartões",
  "cards.tabInvoices": "Faturas",
  "cards.monthlyPaymentsEmptyTitle": "Nada devido neste mês",
  "cards.monthlyPaymentsEmptyDesc": "Você está em dia neste mês",
  "cards.paymentCount_one": "{count} despesa",
  "cards.paymentCount_other": "{count} despesas",
  "cards.invoicesPending": "Pendentes",
  "cards.invoicesAll": "Todas",
  "cards.invoicePaid": "Paga",
  ...
  "cardDetail.emptyDescMonth": "Nenhuma despesa neste cartão em {month}.",
  "cardDetail.emptyDescMonthFiltered": "Nenhuma despesa {filter} neste cartão em {month}.",
  "cardDetail.remainingToPay": "Falta pagar",
  "cardDetail.invoiceTotal": "Total da fatura",
  "cardDetail.markMonthPaid": "Marcar fatura de {month} como paga",
  "cardDetail.markMonthPaidDesc": "Marca a fatura de {month} deste cartão como paga ao emissor — não altera quem te deve por cada despesa",
  "cardDetail.monthPaid": "A fatura de {month} está paga",
  "cardDetail.undoMarkMonthPaid": "Desfazer",
